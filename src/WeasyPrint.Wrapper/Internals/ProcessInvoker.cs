namespace WeasyPrint.Wrapper.Internals
{
    ...
    internal partial class ProcessInvoker
    {
        ...
        public ProcessInvoker(string workingDir, string fileName, string args, bool isInteractive, Encoding encoding, ITraceWriter trace)
        {
